...
const Consultancy = () => {
  ...
  return (
    <div className="w-full md:py-20 py-8 bg-sky-700 flex px-8 flex-col justify-center items-center gap-4 ">
      ...
      <button className="mt-8 rounded-lg text-sm tracking-wide h-12 px-6 text-white hover:text-yellow-300 bg-transparent border-[2px] border-sky-300 hover:border-sky-500 transition-all"
      onClick={()=>{
        navigate("/contact");
      }}
      >
