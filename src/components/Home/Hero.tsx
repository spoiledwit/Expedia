    ...
    <div className="flex w-full h-[calc(100vh)] justify-center items-center">
      ...
      <div className="absolute w-full h-full flex px-40">
        <div className="flex flex-col mt-20 justify-center">
          ...
          We are trusted immigration consultants who can handle <br /> your case and Our professional registered agents will assist you <br /> with your visa application.
          </p>
